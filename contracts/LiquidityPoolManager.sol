...
import "../implementations/output/OrionProtocolImplementationPointer.sol";

contract LiquidityPoolManager is
    Ownable,
    OwnerRecovery,
    OrionProtocolImplementationPointer
{
    ...
    constructor(
        ...
        changeOrionProtocolImplementation(address(leftSide));
